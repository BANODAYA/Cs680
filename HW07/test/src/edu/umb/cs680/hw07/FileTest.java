...
//	    void verify_FileA() {
//			
//			String[] expected = {  "a", "100","false", date.toString(), "applications" };
//			File actual = a;
...
//	    void verify_FileB() {
//			
//			String[] expected = {  "b", "200", "false",date.toString(), "applications" };
//			File actual = b;
//			assertArrayEquals(expected, fileToString(actual));
//		}
//
...
//		void verify_FileC() {
//			
//			String[] expected = { "c", "300","false", date.toString(), "home" };
//			File actual = c;
//			assertArrayEquals(expected, fileToString(actual));
//		}
//		
...
//		 void verify_FileD() {
//			
//			String[] expected = { "d", "400","false", date.toString(), "home" };
//			File actual = d;
//			assertArrayEquals(expected, fileToString(actual));
//		}
//		
...
//	     void verify_FileE() {
//		
//			String[] expected = { "e", "500","false", date.toString(), "code" };
//			File actual = e;
//			assertArrayEquals(expected, fileToString(actual));
//		}
